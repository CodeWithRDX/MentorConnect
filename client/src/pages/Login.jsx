          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-5xl font-bold text-gray-900 mb-6">
                Welcome Back to<br />MentorConnect
              </h1>
              <p className="text-lg text-gray-600 mb-8">
                Sign in to your account and connect with expert mentors. Get personalized guidance tailored to your entrepreneurial journey.
              </p>
              ...
              >
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full h-12 bg-blue-600 hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-all duration-200 flex items-center justify-center gap-2"
                  >
                    {loading ? (
                      <>
